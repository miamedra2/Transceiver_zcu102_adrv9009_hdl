...
#
# Generated by Vivado on Fri Dec 18 11:11:27 -0800 2020
# SW Build 2405991 on Thu Dec  6 23:38:27 MST 2018
#
# Copyright 1986-2018 Xilinx, Inc. All Rights Reserved. 
#
# usage: xvr_refclk_out.sh [-help]
# usage: xvr_refclk_out.sh [-lib_map_path]
# usage: xvr_refclk_out.sh [-noclean_files]
# usage: xvr_refclk_out.sh [-reset_run]
#
...
# executing this script. Please type 'xvr_refclk_out.sh -help' for more information.
#
...
# Design libraries
design_libs=(xilinx_vip xil_defaultlib xpm gtwizard_ultrascale_v1_7_5)

# Simulation root library directory
sim_lib_dir="vcs_lib"

# Script info
echo -e "xvr_refclk_out.sh - Script generated by export_simulation (Vivado v2018.3 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"C:/software/Xilinx/Vivado/2018.3/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"C:/software/Xilinx/Vivado/2018.3/data/xilinx_vip/include" \
  ...
  vlogan -work gtwizard_ultrascale_v1_7_5 $vlogan_opts +v2k +incdir+"C:/software/Xilinx/Vivado/2018.3/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"C:/software/Xilinx/Vivado/2018.3/data/xilinx_vip/include" \
    "$ref_dir/../../../../adrv9009_zcu102.srcs/sources_1/ip/xvr_refclk_out/sim/gtwizard_ultrascale_v1_7_gthe4_channel.v" \
    "$ref_dir/../../../../adrv9009_zcu102.srcs/sources_1/ip/xvr_refclk_out/sim/xvr_refclk_out_gthe4_channel_wrapper.v" \
    "$ref_dir/../../../../adrv9009_zcu102.srcs/sources_1/ip/xvr_refclk_out/sim/xvr_refclk_out_gtwizard_gthe4.v" \
    "$ref_dir/../../../../adrv9009_zcu102.srcs/sources_1/ip/xvr_refclk_out/sim/xvr_refclk_out_gtwizard_top.v" \
    "$ref_dir/../../../../adrv9009_zcu102.srcs/sources_1/ip/xvr_refclk_out/sim/xvr_refclk_out.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.xvr_refclk_out xil_defaultlib.glbl -o xvr_refclk_out_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./xvr_refclk_out_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./xvr_refclk_out.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key xvr_refclk_out_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc xvr_refclk_out_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./xvr_refclk_out.sh -help\" for more information)\n"
    exit 1
  fi
...
usage()
{
  msg="Usage: xvr_refclk_out.sh [-help]\n\
Usage: xvr_refclk_out.sh [-lib_map_path]\n\
Usage: xvr_refclk_out.sh [-reset_run]\n\
Usage: xvr_refclk_out.sh [-noclean_files]\n\n\
