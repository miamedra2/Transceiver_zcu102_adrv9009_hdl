...
#
# Generated by export_simulation on Fri Dec 18 11:10:32 -0800 2020
#
################################################################################
...
'-reset_run' switch to the './xvr.sh' script.
...
./xvr.sh -noclean_files

For more information on the script, please type './xvr.sh -help'.
