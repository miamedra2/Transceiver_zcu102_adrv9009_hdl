...
#
# Generated by Vivado on Fri Dec 18 11:10:32 -0800 2020
# SW Build 2405991 on Thu Dec  6 23:38:27 MST 2018
#
# Copyright 1986-2018 Xilinx, Inc. All Rights Reserved. 
#
# usage: xvr.sh [-help]
# usage: xvr.sh [-lib_map_path]
# usage: xvr.sh [-noclean_files]
# usage: xvr.sh [-reset_run]
#
...
# executing this script. Please type 'xvr.sh -help' for more information.
#
...
# Script info
echo -e "xvr.sh - Script generated by export_simulation (Vivado v2018.3 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"C:/software/Xilinx/Vivado/2018.3/data/xilinx_vip/include" \
    "$ref_dir/../../../../adrv9009_zcu102.srcs/sources_1/ip/xvr/sim/gtwizard_ultrascale_v1_7_gthe4_channel.v" \
    "$ref_dir/../../../../adrv9009_zcu102.srcs/sources_1/ip/xvr/sim/xvr_gthe4_channel_wrapper.v" \
    "$ref_dir/../../../../adrv9009_zcu102.srcs/sources_1/ip/xvr/sim/gtwizard_ultrascale_v1_7_gthe4_common.v" \
    "$ref_dir/../../../../adrv9009_zcu102.srcs/sources_1/ip/xvr/sim/xvr_gthe4_common_wrapper.v" \
    "$ref_dir/../../../../adrv9009_zcu102.srcs/sources_1/ip/xvr/sim/xvr_gtwizard_gthe4.v" \
    "$ref_dir/../../../../adrv9009_zcu102.srcs/sources_1/ip/xvr/sim/xvr_gtwizard_top.v" \
    "$ref_dir/../../../../adrv9009_zcu102.srcs/sources_1/ip/xvr/sim/xvr.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.xvr xil_defaultlib.glbl -o xvr_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./xvr_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./xvr.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key xvr_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc xvr_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./xvr.sh -help\" for more information)\n"
    exit 1
  fi
