...
//PARAMETERS
      ...
      parameter C_NUM_F2P_1_INTR_INPUTS = 8;
...
//REG DECLARATIONS
      ...
      reg emio_spi0_sclk_o;
      reg emio_spi0_sclk_t;
      reg emio_spi0_m_o;
      reg emio_spi0_mo_t;
      reg emio_spi0_s_o;
      reg emio_spi0_so_t;
      reg emio_spi0_ss_o_n;
      reg emio_spi0_ss1_o_n;
      reg emio_spi0_ss2_o_n;
      reg emio_spi0_ss_n_t;
      reg emio_spi1_sclk_o;
      reg emio_spi1_sclk_t;
      reg emio_spi1_m_o;
      reg emio_spi1_mo_t;
      reg emio_spi1_s_o;
      reg emio_spi1_so_t;
      reg emio_spi1_ss_o_n;
      reg emio_spi1_ss1_o_n;
      reg emio_spi1_ss2_o_n;
      reg emio_spi1_ss_n_t;
      reg pl_resetn0;
      reg pl_clk0;
      reg pl_clk1;
      reg pl_clk2;
...
import "DPI-C" function void ps8_init_c_model();
 ...
 always@(posedge pl_ps_irq1[5])
 begin
  ps8_set_input_pl_ps_irq1(5,1);
end

 always@(negedge pl_ps_irq1[5])
 begin
  ps8_set_input_pl_ps_irq1(5,0);
end

 always@(posedge pl_ps_irq1[6])
 begin
  ps8_set_input_pl_ps_irq1(6,1);
end

 always@(negedge pl_ps_irq1[6])
 begin
  ps8_set_input_pl_ps_irq1(6,0);
end

 always@(posedge pl_ps_irq1[7])
 begin
  ps8_set_input_pl_ps_irq1(7,1);
end

 always@(negedge pl_ps_irq1[7])
 begin
  ps8_set_input_pl_ps_irq1(7,0);
end
