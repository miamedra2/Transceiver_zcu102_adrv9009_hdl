...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {axi_regs:axi_rx_bram:axi_tx_bram} \
 ] $axi_clk
  ...
  connect_bd_intf_net -intf_net axi_cpu_interconnect_M16_AXI [get_bd_intf_ports axi_regs] [get_bd_intf_pins axi_cpu_interconnect/M16_AXI]
  connect_bd_intf_net -intf_net axi_cpu_interconnect_M17_AXI [get_bd_intf_ports axi_tx_bram] [get_bd_intf_pins axi_cpu_interconnect/M17_AXI]
  connect_bd_intf_net -intf_net axi_cpu_interconnect_M18_AXI [get_bd_intf_ports axi_rx_bram] [get_bd_intf_pins axi_cpu_interconnect/M18_AXI]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x80020000 [get_bd_addr_spaces sys_ps8/Data] [get_bd_addr_segs axi_rx_bram/Reg] SEG_axi_rx_bram_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x80010000 [get_bd_addr_spaces sys_ps8/Data] [get_bd_addr_segs axi_tx_bram/Reg] SEG_axi_tx_bram_Reg
